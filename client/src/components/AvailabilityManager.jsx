...
//                                 border: isSelected ? '2px solid #46a1a1' : '2px solid rgba(255, 255, 255, 0.2)',
//                                 background: isSelected ? 'linear-gradient(135deg, rgb(5, 45, 63) 0%, #0d5c6e 100%)' : 'rgba(255, 255, 255, 0.08)',
...
//               <div style={{ backgroundColor: 'rgba(70, 161, 161, 0.1)', border: '1px solid rgba(70, 161, 161, 0.3)', borderRadius: '8px', padding: '0.75rem', fontSize: '0.875rem', color: 'rgba(255, 255, 255, 0.7)', fontStyle: 'italic', lineHeight: '1.4' }}>
...
//                                       .map(avail => (
//                                         <tr key={avail.id}>
//                                           {isAdmin && <td className="fw-bold" style={{ color: '#fff', padding: '8px' }}>{avail?.user?.name || 'Unknown'}</td>}
...
//                                   .sort((a, b) => a.startTime.localeCompare(b.startTime))
//                                   .map(avail => (
//                                     <div key={avail.id} className="card mb-3" style={{ border: '2px solid rgba(70, 161, 161, 0.3)', background: 'rgba(255, 255, 255, 0.06)' }}>
//                                       <div className="card-body p-3">
//                                         {isAdmin && (
//                                           <div className="mb-2">
//                                             <small className="text-muted d-block">{t('employee')}</small>
//                                             <strong style={{ color: '#fff' }}>{avail?.user?.name || 'Unknown'}</strong>
//                                           </div>
//                                         )}
